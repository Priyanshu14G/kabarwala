...
export default function About() {
  ...
  const team = [
    { name: "Dr. Rajesh Bhat", role: "Founder & Director" },
    { name: "Priya Desai", role: "Operations Head" },
    { name: "Amit Sharma", role: "Tech Lead" },
    { name: "Neha Gupta", role: "Community Manager" },
  ]
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((member, idx) => (
            ...
            >
              <img src="/professional-headshot.png" alt={member.name} className="w-full h-48 object-cover" />
